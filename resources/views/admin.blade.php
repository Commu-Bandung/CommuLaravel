      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav js-nav-add-active-class">
            ...
            <li><a href="{{ url('/profiladmin') }}">Profilku</a></li>
            <li><a href="{{ url('/validasi') }}">validasi</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right hidden-xs">
            <a type="button" class="navbar-btn btn btn-gradient-red" am-latosans="bold"  href="{{ url('/logoutadmin') }}">logout</a>
          </ul>
          @else
          </ul>
          <ul class="nav navbar-nav navbar-right hidden-xs">
            <a type="button" class="navbar-btn btn btn-gradient-blue" am-latosans="bold"  href="{{ url('/loginadmin') }}">Login</a>
          </ul>            
          @endif
        </div><!-- /.navbar-collapse -->
      </div>
